...
const defaultMetaKeys = ["service", "environment"];
addColors({
    error: "red",
    warn: "yellow",
    info: "green",
...
const consoleFormat = combine(colorize({ all: true }), timestamp({ format: "YYYY-MM-DD HH:mm:ss.SSS" }), errors({ stack: true }), splat(), printf((info) => {
    const metadata = { ...info };
