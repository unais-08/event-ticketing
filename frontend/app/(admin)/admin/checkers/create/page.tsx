...
import { createCheckerAccount } from "@/app/_lib/api";
...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert("Checker account created successfully.");
            ...
            router.push("/admin/checkers");
        } catch (err) {
            setError(
                getApiErrorMessage(err, "Unable to create checker account.")
            );
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="mx-auto w-full max-w-md px-6 py-16">
            <h1 className="mb-6 text-2xl font-semibold">Create Checker Account</h1>
